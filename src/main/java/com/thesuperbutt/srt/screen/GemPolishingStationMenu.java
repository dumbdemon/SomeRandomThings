...
public class GemPolishingStationMenu extends AbstractContainerMenu {
    ...
    public GemPolishingStationMenu(int pContainerID, Inventory inv, @NotNull FriendlyByteBuf extraData) {
        this(pContainerID, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public GemPolishingStationMenu(int pContainerID, Inventory inv, BlockEntity blockEntity, ContainerData data) {
